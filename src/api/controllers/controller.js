...
exports.list_all_countries = (req, res, next) => {
    let sql = 'SELECT id, name FROM Country';
    var params = [];
...
exports.list_all_teams = (req, res, next) => {
    let sql = 'SELECT id, team_long_name AS full_name, team_short_name AS short_name  FROM Team';
    var params = [];
...
exports.get_player_info = (req, res, next) => {
    let sql = "SELECT id AS id, player_name AS name, DATE('now')-birthday AS age, weight, height FROM Player WHERE id = ?";
